...
**Business Documentation**: Strategic guidance, implementation methodologies, and change management frameworks for fund leaders and decision-makers. This section covers the business case, use cases, and proven approaches for successful data transformation.

**Technical Documentation**: API references, integration guides, and technical specifications for developers and technical teams implementing AMOS.

Our approach recognizes that successful data transformation requires both technical excellence and organizational change management. Both our platform and our methodology are open source—we believe in transparency not just in code, but in sharing the proven practices that make data projects successful.
...
<Cards>
  <Card title="Unified Data Layer" icon="🔗">

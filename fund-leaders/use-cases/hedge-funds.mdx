...
<CardGroup cols={3}>
  ...
  <Card title="Regulatory Compliance" icon="check-shield">
...
<CardGroup cols={2}>
  <Card title="Multi-Strategy Fund" icon="layers" href="/fund-leaders/success-stories/case-study-1">
